		...
		<section class="container-flex seccion-politicas pb-5 bg-light">
			<div class="row">
				...
				<div class="col-md-9 contenido">
					...
					<p>
						Como contrapartida de la prestación de servicios que ofrece RetroCicla, el usuario podrá cumplir
						su obligación efectuando el pago adeudado por cualquiera de los siguientes medios habilitados en
						la plataforma:
					</p>
					<ul class="ms-4">
					...
					<p>
						En el caso de los contratos que sean celebrados de forma única, que devenguen sus efectos para
						una situación determinada, o bien que se desprenda del tenor de aquellos que sus efectos no
						serán reiterados en el tiempo, como lo es la compraventa de A kg de fibra o de X material, podrá
						el usuario hacer uso del pago vía tarjeta asociada al sistema de Redcompra, transferencia
						bancaria a la cuenta asociada a RetroCicla, e inclusive cumplir su obligación pagando mediante
						link de pago o código QR que contenga el valor del servicio contratado, siendo estos últimos
						proveídos por la empresa que ofrece sus servicios.
					</p>
					<p class="mb-3 mt-3 fw-bold">II. De la facultad de retracto.</p>
					<p>
						El usuario podrá dejar sin efecto el contrato celebrado con RetroCicla de forma unilateral
						siempre y cuando manifieste en tiempo y forma dicha intención.
					</p>
					<ul class="ms-4">
						<li>
							<p>
								...
								importancia alta un correo electrónico a la casilla de RetroCicla expresando su
								intención de no persistir en el contrato y las causas que motivaron dicha decisión; no
								deberá pagar ningún monto, sin embargo, en el evento que el servicio esté pendiente a su
								ejecución, debiendo en este último caso contactarse el usuario por la vía más expedita
								con la empresa a fin que aquella no persista con el servicio.
							</p>
						</li>
						<li>
							<p>
								En el caso de los contratos de tracto sucesivo, será menester que en caso que no haya
								usado los servicios que como empresa ofrecemos, el usuario redacte y envíe el correo
								mencionado anteriormente con a lo máximo con a lo máximo una semana hábil antes de que
								se devengue el próximo pago; de haber continuado usando estos servicios, el usuario
								deberá pagar su cuota mensual respectiva antes de solicitar el cese de los servicios y
								consecuentemente el pago de aquellos.
							</p>
						</li>
						<li>
							<p>
								No se entenderá que el usuario manifiesta su intención de desafiliación, no obstante
								haya enviado el citado correo, cuando ejecute actos que desprendan la intención de
								persistir en la prestación de servicios, tales como celebrar un acto de compraventa
								respecto a X cantidad de materiales, o bien A kg de determinada fibra, por mencionar
								algunos ejemplos.
							</p>
						</li>
					</ul>
