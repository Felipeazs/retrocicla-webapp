						...
						<div class="container-fluid">
							<div class="collapse navbar-collapse" id="navbarNav">
								<ul class="navbar-nav">
									...
									<li class="nav-item"><a class="nav-link" href="#">Tienda</a>
									</li>
				...
				<div class="row">
					<div class="section-content section-content-p30">
						<div class="detail-section">
							...
							<div id="successful-result" style="display: none">Su contraseña ha sido modifica correctamente</div>
							<div id="unsuccessful-result" style="display: none">Error con el cambio de contraseña</div>		
							...
							<form>
								...
								<br/>
								<div>
									<input type="button" class="btn btn-primary" value="Aceptar" onclick="submitnewpassword()"/>
								</div>
							</form>
							</div>								
						</div>
