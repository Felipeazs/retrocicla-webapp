		...
		<section class="container-flex seccion-politicas pb-5 bg-light">
			<div class="row">
				...
				<div class="col-md-9 contenido">
					...
					<p>
						En el evento que usted como usuario presente alguna duda sobre la presente política de privacidad y
						otras políticas, las prácticas que efectúe la plataforma tecnológica digital o las relaciones
						Usuario / RetroCicla, podrá contactarse con la empresa haciendo uso de cualquiera de los siguientes
						medios:
					</p>
					<ul class="ms-4">
					...
					<p>
						...
						responderemos dentro de un tiempo prudente. No obstante lo anterior, serán consideradas como no
						...
						entre otros, todos los cuales podrán ser borrados por cualquiera de los miembros de la empresa sin
						expresión de causa. En caso de reiteración de conducta, los miembros poseen la facultad inamovible
						de vetar permanentemente de los servicios al emisor de dichos comentarios así como aplicar todas las
