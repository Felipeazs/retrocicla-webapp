				...
				<div class="col-md-7">					
					<section class="">
						...
						<div class="mb-2 envios d-flex justify-content-between">
							<div class="formulario">
								<input type="radio" class="form-check-input"id="radio" name="radio" />
								<label for="radio" class="form-check-label">Otras comunas del resto del país. STARKEN POR PAGAR.</label>								
							</div>
							<div class="formulario">								
						...
						<div class="mb-2 justify-content-between envios">
							<div class="formulario">
								<input type="radio" class="form-check-input" id="radio" name="radio" />
								<label for="radio" class="form-check-label">Otras comunas del resto del país. CORREOSEXPRESS POR PAGAR.</label>								
							</div>
							<div class="formulario">								
								<label for="radio" class="form-check-label">$1</label>								
							</div>
						...
						<div class="mb-2 justify-content-between envios">
							<div class="formulario">
								<input type="radio" class="form-check-input" id="radio" name="radio" />
								<label for="radio" class="form-check-label">Otras comunas del resto del país. CORREOS DE CHILE POR PAGAR.</label>								
							</div>
							<div class="formulario">								
								<label for="radio" class="form-check-label">$1</label>								
							</div>
						...
						<div class="mb-2 envios">
							<div class="formulario">
								<input type="radio" class="form-check-input" id="radio" name="radio" />
								<label for="radio" class="form-check-label">R. Valparaíso: Curauma, Valparaíso, Viña del Mar, Reñaca, Concón.</label>								
							</div>
							<div class="formulario">								
						...
						<div class="mb-2 justify-content-between envios">
							<div class="formulario">
								<input type="radio" class="form-check-input" id="radio" name="radio" checked/>
								<label for="radio" class="form-check-label">R. Valparaíso: Quilpué, Villa Alemana, Peña Blanca, Limache, Olmué y Quillota.</label>								
							</div>
							<div class="formulario">								
						...
						<div class="mb-2 justify-content-between envios">
							<div class="formulario">
								<input type="radio" class="form-check-input" id="radio" name="radio" />
								<label for="radio" class="form-check-label">R. Valparaíso: La Calera, La Cruz, Santo Domingo, Algarrobo y Cartagena.</label>								
							</div>
							<div class="formulario">								
						...
						<div class="row justify-content-start">
							<div class="col-md-3">
								<a href="informacion-pago"><button class="boton fs-6 p-2 mt-3">Continuar</button></a>
							</div>
							<div class="col-md-2">
								<a href="informacion-usuario"><button class="boton fs-6 p-2 mt-3 bg-transparent">Volver</button></a>
